{
 "cells": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 15,
   "id": "8b649501-26ce-4a3a-865d-f5472ce868b8",
   "metadata": {},
   "outputs": [
    {
     "name": "stdout",
     "output_type": "stream",
     "text": [
      "[246, 408, 473, 247, 434, 145, 594, 461, 573, 129, 396, 330, 211, 680, 564, 381, 684, 567, 448, 521, 304, 329, 318, 132, 105, 493, 539, 164, 675, 691, 337, 131, 286, 435, 369, 390, 106, 168, 187, 469, 297, 612, 204, 585, 576, 512, 542, 688, 577, 205, 182, 450, 548, 654, 662, 431, 478, 561, 416, 558, 233, 125, 163, 316, 629, 626, 226, 503, 207, 232, 533, 126, 608, 530, 622, 516, 166, 579, 142, 507, 138, 508, 559, 397, 399, 509, 174, 342, 252, 595, 681, 354, 466, 361, 525, 407, 589, 677, 609, 598, 115, 244, 370, 417, 610, 540, 410, 148, 518, 646, 212, 649, 222, 591, 348, 586, 536, 488, 652, 411, 394, 206, 619, 519, 534, 391, 311, 650, 319, 202, 190, 253, 676, 658, 295, 392, 578, 274, 298, 556, 475, 664, 641, 444, 538, 572, 458, 309, 162, 273]\n"
     ]
    }
   ],
   "source": [
    ...
    "randomlist = random.sample(range(100, 700), 150)\n",
    "print(randomlist)"
   ]
  },
  {
   ...
   "id": "073cd7f9-ec40-4bd7-babb-e655fe26fb64",
   "metadata": {},
   "outputs": [],
   "source": []
  }
